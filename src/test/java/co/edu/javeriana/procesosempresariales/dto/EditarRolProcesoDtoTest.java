...
class EditarRolProcesoDtoTest {
    ...
    private Set<String> camposConError(EditarRolProcesoDto dto) {
    ...
    private EditarRolProcesoDto formularioValido() {
        return new EditarRolProcesoDto("Analista de credito", "Evalua el riesgo de cada solicitud");
    }
    ...
    void elNombreEsObligatorio() {
        EditarRolProcesoDto dto = formularioValido();
        dto.setNombre("   ");
